...
export default function LoginPage() {
  ...
  useEffect(() => {
    ...
    if (hasRole("admin")) {
      ...
      router.replace("/staff/pharmacy/prescriptions");
          ...
          <div className="w-full max-w-[400px] animate-in slide-in-from-right-4 duration-300">
            ...
            <div className="mb-10">
              <h2 className="text-3xl font-bold text-[#191c1e] mb-3 tracking-tight" style={{ fontFamily: 'var(--font-manrope)' }}>
                {portal === "student" ? "Welcome Student" : portal === "staff" ? "Staff Login" : "Admin Authentication"}
              </h2>
              <p className="text-sm font-medium text-[#727783]" style={{ fontFamily: 'var(--font-public-sans)' }}>
                Please sign in to securely access the clinical portal.
              </p>
            </div>
            ...
            <form onSubmit={handleLogin} className="space-y-5">
              ...
              <div className="space-y-2 relative">
                <div className="flex items-center justify-between ml-1">
                  ...
                  <a href="#" className="text-xs font-bold text-[#005eb8] hover:text-[#00478d]">Forgot?</a>
                </div>
