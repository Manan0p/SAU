...
import {
  ...
  Pill, ShieldCheck, FileClock, User,
} from "lucide-react";
    ...
    <aside className="fixed left-0 top-0 h-full w-64 bg-slate-950/95 border-r border-white/5 flex flex-col z-40 backdrop-blur-xl">
      ...
      <div className="flex items-center gap-3 px-6 py-6 border-b border-white/5">
        ...
        <div>
          ...
          <p className="text-xs text-violet-400 font-semibold">Admin Portal</p>
        </div>
      </div>
      ...
      <div className="px-4 pb-6 border-t border-white/5 pt-4">
        <div className="flex items-center gap-3 mb-3">
          <div className="w-9 h-9 rounded-full bg-gradient-to-br from-violet-500 to-fuchsia-600 flex items-center justify-center text-white text-xs font-bold shrink-0">
